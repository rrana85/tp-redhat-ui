...
const EditableSelectInputCell = ({ value, rowIndex, cellIndex, onSelect = () => { }, clearSelection, isOpen = false, isPlaceholder = false, onToggle = () => { }, selections = [''], options = [], props }) => {
    ...
    const select = (React.createElement(Select_1.Select, Object.assign({ onSelect: onSelectHandler }, (clearSelection && { onClear }), { isOpen: isOpen, selected: selections, toggle: (toggleRef) => (React.createElement(MenuToggle_1.MenuToggle, { ref: toggleRef, onClick: onToggle, isExpanded: isOpen, isPlaceholder: isPlaceholder }, isOpen ? 'Expanded' : 'Collapsed')) }, props.editableSelectProps),
        React.createElement(Select_1.SelectList, null, options)));
