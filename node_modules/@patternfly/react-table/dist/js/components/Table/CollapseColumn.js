...
const CollapseColumn = (_a) => {
    ...
    return (React.createElement(React.Fragment, null,
        isOpen !== undefined && (React.createElement(Button_1.Button, Object.assign({ className: (0, react_styles_1.css)(className, isOpen && table_1.default.modifiers.expanded) }, props, { variant: "plain", "aria-label": props['aria-label'] || 'Details', onClick: onToggle, "aria-expanded": isOpen, icon: React.createElement("div", { className: (0, react_styles_1.css)(table_1.default.tableToggleIcon) },
